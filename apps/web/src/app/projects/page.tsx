    ...
    <div className="mx-auto max-w-6xl space-y-10">
      <header className="text-center">
        ...
        <p className="mx-auto max-w-3xl text-lg leading-8 text-slate-700">
          Selected work in numerical methods, quantitative finance and
          optimisation. Each project links to its source and states what has
          been tested, alongside the limits of experimental work.
        </p>
      </header>
